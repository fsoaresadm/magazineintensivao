...
function criarPedidoHistorico(pedidoComData) {
    ...
    `<p class="text-xm text-bold my-4">${new Date(pedidoComData.dataPedido).toLocaleDateString("pt-BR", {hour: "2-digit", minute: "2-digit"})}</p>
...
function reinderizarHistoricoPedidos() {
